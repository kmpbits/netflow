...
kotlin {
    ...
    val xcframework = XCFramework("netflowTokenStorage")
    ...
    listOf(
        ...
        it.binaries.framework {
            baseName = "netflowTokenStorage"
            isStatic = true
            export(project(":netflow-core"))
            binaryOption("bundleId", "com.kmpbits.netflowTokenStorage")
...
val artifactId = "netflow-token-storage"
...
android {
    namespace = "com.kmpbits.netflow_token_storage"
    compileSdk = 35
    defaultConfig {
        minSdk = 24
    }
...
mavenPublishing {
    ...
    pom {
        name = "NetFlow Token Storage KMP"
        description = "Persistent TokenStorage implementations for NetFlow auth"
        inceptionYear = "2024"
